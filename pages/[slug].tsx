  ...
  return (
    <div className="bg-white dark:bg-black">
      <Head>
        ...
        <meta name="description" content={`${process.env.NEXT_PUBLIC_WEBSITE_TITLE?.replaceAll(/"/, '')}: ${props.pageResult.post.title}`}/>
      </Head>
      <nav className="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-center mx-auto p-4">
          <Link href="/" className="flex-items-center">
            <span className="bg-gradient-to-r from-green-400 via-blue-500 to-purple-600 bg-clip-text font-extrabold text-transparent text-md sm:text-lg leading-tight sm:leading-tight lg:leading-relaxed">{process.env.NEXT_PUBLIC_WEBSITE_TITLE?.replaceAll(/"/, '')}</span>
          </Link>
        </div>
      </nav>
